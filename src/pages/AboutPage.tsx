...
const AboutPage = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'We maintain the highest standards of physical therapy through continuous education and evidence-based practices.'
    },
    {
      icon: Users,
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-12 mb-20 lg:grid-cols-2">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold text-gray-900 lg:text-4xl">Our Story</h2>
              <p className='pb-4 text-xl text-blue-700'>A Decade of Healing—Now for Pets</p>
              <p className="text-lg leading-relaxed text-gray-900">
                With over 10 years of experience as a licensed physical therapist, I’ve had the privilege of helping countless individuals regain strength, reduce pain, and return to doing what they love. Throughout my career, I’ve seen how powerful rehabilitation can be—not just physically, but emotionally—and I’ve long believed that our animal companions deserve the same level of care and attention.
              </p>
              <p className="text-lg leading-relaxed text-gray-900">
                As a lifelong animal lover, I began to see a need in our community: pet owners looking for safe, effective ways to support their animals through injury recovery, surgery rehab, chronic pain, and age-related mobility changes. This inspired me to take the next step in my career and begin formal training in animal rehabilitation and therapy.
              </p>
              <p className="text-lg leading-relaxed text-gray-900">
                Although Paw Power Rehab is a new practice, it’s built on a strong foundation of clinical expertise, compassionate care, and a deep commitment to improving quality of life. My extensive background in human physical therapy allows me to bring a seasoned, evidence-based approach to every animal I work with, while I continue expanding my education specifically in veterinary rehabilitation.
              </p>
            </div>
            <div className="relative">
              <img
                src="/openart-image_P4_BeiZw_1750798712020_raw.png"
          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div className="relative order-2 lg:order-1">
              <img
                src="/openart-image_Wo-j3pil_1750798839504_raw.png"
                alt="A dog"
                className="w-full h-[400px] object-cover rounded-2xl shadow-xl"
              />
            </div>
            <div className="order-1 space-y-6 lg:order-2">
              <h2 className="text-3xl font-bold text-gray-900 lg:text-4xl">Our Mission</h2>
              <p className="text-lg leading-relaxed text-gray-600">
                At Paw Power Rehab, our mission is simple: to provide thoughtful, personalized care that helps your pet feel better, move better, and live more fully. We may be new to the animal rehab space, but we’re grounded in years of healing experience—and we’re honored to support your pet’s wellness journey.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            {team.map((member, index) => (
                  ...
                  <div className="mb-1 font-medium text-blue-700">{member.title}</div>
                  <div className="mb-3 text-sm text-gray-500">{member.credentials}</div>
        ...
        <div className="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 gap-8 mt-12 md:grid-cols-4">
              ...
              <div className="p-6 bg-white bg-opacity-10 rounded-xl">
              <div className="mb-2 text-2xl font-bold text-white">Cert. DN</div>
              <div className="text-blue-100">Certified in Dry Needling</div>
              </div>
              <div className="p-6 bg-white bg-opacity-10 rounded-xl">
              <div className="mb-2 text-2xl font-bold text-white">Cert. SMT</div>
              <div className="text-blue-100">Certified in Spinal Manipulative Therapy</div>
              </div>
            </div>
          </div>
        </div>
