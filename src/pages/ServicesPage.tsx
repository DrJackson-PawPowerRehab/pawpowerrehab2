...
import {MousePointerClick, Hand, Dumbbell, Zap, Heart, Clock, CheckCircle } from 'lucide-react';
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="text-center">
              ...
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Initial Assessment</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Active Treatment</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Progress Monitoring</h3>
